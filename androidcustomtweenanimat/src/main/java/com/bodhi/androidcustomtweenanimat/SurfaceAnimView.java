            ...
            while (isRun) {
                ...
                try {
                    synchronized (surfaceHolder) {
                        canvas = surfaceHolder.lockCanvas();//锁定整个 SurfaceView 对象，获取该 Surface 上的 Canvas。
                        /**清除画面*/
                    ...
                    if (canvas!=null) {
                        surfaceHolder.unlockCanvasAndPost(canvas);//释放 Canvas 并提交绘制：
                    }
                }
